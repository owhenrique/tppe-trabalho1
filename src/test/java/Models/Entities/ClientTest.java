...
public class ClientTest {
    ...
    public static Collection<Object[]> getParameters(){
        return Arrays.asList(new Object[][] {
                ...
                {"André", "12345678901", EClientType.ESPECIAL, "SP", EAddress.INTERIOR, "Sudeste", 150.0, 0.0, EClientType.ESPECIAL},
                ...
                {"Analice", "12345678904", EClientType.PRIME, "RJ", EAddress.CAPITAL, "Sudeste", 0.0, 20.00, EClientType.PRIME},
                {"Ana Clara", "12345678905", EClientType.PRIME, "RJ", EAddress.CAPITAL, "Sudeste", 0.0, 20.00, EClientType.PRIME},
                {"Júlia", "12345678906", EClientType.STANDARD, "RJ", EAddress.CAPITAL, "Sudeste", 0.0, 0.0, EClientType.STANDARD},
                {"Vitória", "12345678907", EClientType.STANDARD, "RJ", EAddress.CAPITAL, "Sudeste", 0.0, 0.0, EClientType.STANDARD},
        });
    }
